...
public sealed class ForwardingTools
{
    ...
    public Task<string> WaitForElement(
    ...
    public Task<string> SetWindowState(
    ...
    public Task<string> BringToFront(
        [Description("Optional window element id; omit for the main window.")] string? id = null,
        CancellationToken ct = default) =>
    ...
    public Task<string> DescribeAppTools(CancellationToken ct = default) =>
    ...
    public Task<string> InvokeAppTool(
        ...
        CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            if (doc.RootElement.ValueKind != JsonValueKind.Object)
                return Task.FromResult(ErrorJson(PilotErrorCodes.InvalidArgs, "parametersJson must be a JSON object."));
            args = doc.RootElement.Clone();
        }
        catch (JsonException ex)
        {
            return Task.FromResult(ErrorJson(PilotErrorCodes.InvalidArgs, "parametersJson must be valid JSON.", ex.Message));
        }
